...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    for elf in $out/share/cromite/{chrome,chrome_sandbox,chrome_crashpad_handler}; do
      ...
      patchelf --add-needed libGL.so.1 --add-needed libEGL.so.1 $elf
